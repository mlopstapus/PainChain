...
│   │   └── models.py           # ChangeEvent, Connection models
│   ├── api/                    # FastAPI service
...
│   │   ├── github/
│   │   │   ├── connector.py    # GitHub API integration
│   │   │   ├── main.py         # Standalone entry point
│   │   │   ├── requirements.txt
│   │   │   ├── Dockerfile
│   │   │   └── README.md       # Detailed GitHub setup guide
│   │   ├── gitlab/
│   │   │   └── connector.py
│   │   └── kubernetes/
│   │       └── connector.py
...
│   ├── src/
│   │   ├── pages/
│   │   │   ├── Dashboard.jsx   # Main event timeline
│   │   │   └── Settings.jsx    # Connector configuration
│   │   ├── components/
│   │   ├── config/
│   │   │   └── connectorConfigs.json  # Dynamic connector definitions
│   │   └── utils/
│   ├── Dockerfile
│   └── package.json
...
List all change events with filtering.

Query parameters:
- `source` - Filter by connector (github, gitlab, kubernetes)
- `status` - Filter by status
- `start_date` - ISO 8601 timestamp
- `end_date` - ISO 8601 timestamp
- `tag` - Filter by tags (multi-select)
...
Get event statistics (counts by source, status).
...
Create a new team with tag subscriptions.
